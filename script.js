...
let currentQuery = "Tigers";

function fetchDataAndDisplayImages(query) {
...
submitBtn.addEventListener("click", function () {
  ...
  fetchDataAndDisplayImages(currentQuery);
});

loadB.addEventListener("click", function () {
  fetchDataAndDisplayImages("Tigers");
  currentQuery = "Tigers";
});

loadBM.addEventListener("click", function () {
  fetchDataAndDisplayImages("Dogs");
  currentQuery = "Dogs";
});
